...
//URL
* url = "https://fhir.example.org/Questionnaire/populate"
* version = "0.1"
* name = "populate"
* title = "Ejemplo de Populate"
* status = #active
* date = "2025-10-08"
* publisher = "UMA Health"
* description = "Formulario de ejemplo para JIS 2025"
* useContext[+].code = $sct#394733009 "especialidades médicas"
* useContext[=].valueCodeableConcept = $sct#123456789 "populate"
...
* item[+]
  ...
  * item[+]
    ...
    * item[+]
      ...
      * text = "Buscar alergias (busqueda por texto)"
      * required = false
      * repeats = false
      * readOnly = false
